...
bool Adafruit_SensorLab::detectICM20948(void)
{
  ...
  if ((addr68 && _icm20948->begin_I2C(0x68, _i2c)) ||
      (addr69 && _icm20948->begin_I2C(0x69, _i2c)))
  {
...
// bool Adafruit_SensorLab::detectHMC5883(void)
// {
...
//   _hmc5883 = new Adafruit_HMC5883();
//   if (addr0d && _HMC5883->begin_I2C(0x5F, _i2c))
//   {
//     // we got one!
//     Serial.println(F("Found a Adafruit_HMC5883"));
//     if (!humidity)
//       humidity = _hmc5883->getHumiditySensor();
//     if (!temperature)
//       temperature = _hmc5883->getTemperatureSensor();
//     return true;
//   }
//   delete _hmc5883;
//   return false;
...
Adafruit_Sensor *Adafruit_SensorLab::getAccelerometer(void)
{
  ...
  if (detectADXL34X() || detectLSM6DS33() || detectLSM6DS3TRC() ||
      detectLSM6DSOX() || detectFXOS8700() || detectICM20948() ||
...
Adafruit_Sensor *Adafruit_SensorLab::getMagnetometer(void)
{
  ...
  if (detectLIS3MDL() || detectLIS2MDL() || detectFXOS8700() ||
      detectLSM9DS1() || detectICM20948() || detectLSM9DS0() || detectMLX90393() ||
      detectMMC5603())
  {
    return magnetometer;
  }
...
Adafruit_Sensor *Adafruit_SensorLab::getGyroscope(void)
{
  ...
  if (detectLSM6DS33() || detectLSM6DS3TRC() || detectLSM6DSOX() ||
      detectICM20948() || detectISM330DHCX() || detectFXAS21002() ||
